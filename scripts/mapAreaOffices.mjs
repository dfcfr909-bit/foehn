...
const MANUAL = {
  ...
  /* ⚠ **分水嶺の上に立つ山頂。** 逆ジオコーダは片側を答えるが、
       どちらでも間違いではない。**利用者の認識と食い違わない方**を採った
       （気象的にどちらもあり得るなら、現場で迷わせない方がよい）。 */
  '平ヶ岳': { codes: ['150000'], why: '長野…ではなく群馬と出たが、「越後」の山という認識が強い。新潟県' },
  '赤岳':   { codes: ['200000'], why: '長野/山梨の県境。入山は長野側（美濃戸・稲子湯）が主で、同じ山域の天狗岳も長野' },
};
